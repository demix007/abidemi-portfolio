...
const portfolioProjects = [
  {
    ...
    year: "2023",
    title: "Bravort Institute Of Technology",
    results: [
      { title: "Enhanced user experience by 40%" },
      { title: "Improved site speed by 50%" },
      { title: "Increased mobile traffic by 35%" },
    ],
    link: "https://www.bravort.com/",
    image: BravortLandingPage,
  },
  {
    company: "Chariz Groups",
    year: "2023",
    title: "Chariz Innovations",
    results: [
                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                    {project.results.map((result) => (
                      <li
                        key={result.title}
                        className="flex gap-2 text-sm md:text-base text-whote/50"
                      >
                  ...
                  <a href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full md:width-auto md:px-8 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
